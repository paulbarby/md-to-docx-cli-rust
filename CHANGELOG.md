...
- Native Rust CLI for converting Markdown files to Word `.docx` documents.
- Recursive directory conversion for bulk processing.
...
- Improved heading rendering with explicit DOCX formatting for heading levels.
- Added visible spacing for paragraph and line-break handling.
- Converted Markdown list items into native Word list formatting.
